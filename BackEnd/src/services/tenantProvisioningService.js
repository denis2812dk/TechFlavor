...
export const initializeTenantDatabase = async (tenantDb) => {
    ...
    try {
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'restaurant_settings' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'menu_categories' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'menu_products' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'menu_combos' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'menu_combo_items' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'restaurant_zones' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'tables' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'reservations' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'orders' creada.");
        // --------------------------------------
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'order_items' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'ingredients' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'inventory' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'product_ingredients' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'suppliers' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'supplier_ingredients' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'purchase_orders' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'purchase_order_items' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'supplier_incidences' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'inventory_movements' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'promotions' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'promotion_targets' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'cash_shifts' creada.");
        ...
        `);
        console.log("DEBUG: [tenantProvisioningService] Tabla 'cash_movements' creada.");

        console.log("¡Base de datos del inquilino inicializada correctamente!");
    } catch (error) {
        console.error("ERROR: [tenantProvisioningService] Fallo al inicializar la base de datos del tenant:", error);
        throw error; // Re-lanza el error para que sea capturado más arriba
    }
};